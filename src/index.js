...
function createNewTaskElement(task) {
  ...
  removeImgElement.src =
    // eslint-disable-next-line max-len
    'https://cdn4.iconfinder.com/data/icons/devine_icons/Black/PNG/Folder%20and%20Places/Trash-Recyclebin-Empty-Closed.png';
...
function changeTaskState(event) {
  ...
  sort(
    div.parentNode.id,
    div.parentNode.parentNode.querySelector('select[class="sort"]').value,
  );
}
